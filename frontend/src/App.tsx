...
function AppContent() {
  ...
  const canShowHistory = import.meta.env.DEV
  ...
  return (
    <div className="min-h-screen flex flex-col bg-bg-primary text-text-primary">
      <UpdateNotification autoCheckOnMount={!import.meta.env.DEV} />
      <header className="flex items-center justify-between px-6 py-4 border-b border-border">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="p-2 rounded-md hover:bg-bg-secondary transition-colors text-text-muted hover:text-text-primary"
            data-testid="update-toggle-button"
            aria-label="Toggle update settings"
